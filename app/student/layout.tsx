...
const NAV_ITEMS = [
  ...
  { href: '/student/profile', label: 'Perfil', icon: '👤' },
];
    ...
    <ToastProvider>
      <div className="flex h-screen bg-black overflow-hidden">
        ...
        >
          ...
          {/* Navigation */}
          <nav className="flex-1 overflow-y-auto py-4 px-3" aria-label="Navegación estudiante">
          ...
          <div className="p-4 border-t border-white/[0.06] shrink-0">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-white/40 uppercase tracking-wider">Estudiante</p>
              </div>
            </div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-16 shrink-0 flex items-center justify-between px-4 lg:px-6 border-b border-white/[0.06] bg-[#0a0a0a]/80 backdrop-blur-lg">
            ...
            <div className="flex items-center gap-3 lg:hidden">
              <div className="w-7 h-7 rounded-full bg-cyan-500/20 flex items-center justify-center text-[10px] font-bold text-cyan-400">
                {user.firstName.charAt(0)}{user.lastName.charAt(0)}
              </div>
            </div>
          </header>
