  ...
  return (
    <ToastProvider>
      <div className="min-h-screen bg-[var(--color-bg-primary)]">
        {/* ═══ Top Navbar ═══ */}
        <header className="sticky top-0 z-50 border-b border-[var(--color-surface-border)] bg-[var(--color-bg-secondary)]/80 backdrop-blur-xl">
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-8">
                ...
                <Link href="/student" className="flex items-center gap-2.5 shrink-0">
                  ...
                  <span className="text-sm font-semibold text-[var(--color-text-primary)] tracking-tight hidden sm:block">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2.5 px-2 py-1.5 rounded-lg hover:bg-[var(--color-surface-hover)] transition-colors cursor-pointer"
                  ...
                  {userMenuOpen && (
                    <>
                      ...
                      <div className="absolute right-0 mt-2 w-56 rounded-xl border border-[var(--color-surface-border)] bg-[var(--color-bg-secondary)] shadow-[var(--shadow-lg)] z-50 overflow-hidden">
                        {/* User info */}
                        <div className="px-4 py-3 border-b border-[var(--color-surface-border)]">
                          <p className="text-sm font-medium text-[var(--color-text-primary)]">
                            {user.firstName} {user.lastName}
                          </p>
                          <p className="text-[11px] text-[var(--color-text-quaternary)]">Estudiante</p>
                        </div>
                        {/* Links */}
                        <div className="py-1">
                          <Link
                        ...
                        {/* Logout */}
                        <div className="py-1 border-t border-[var(--color-surface-border)]">
                          <button
                            onClick={handleLogout}
                            disabled={loggingOut}
                            className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-[var(--color-error)] hover:bg-[var(--color-error-bg)] transition-colors cursor-pointer disabled:opacity-50"
                          >
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button
                  ...
                  className="md:hidden p-2 rounded-lg text-[var(--color-text-tertiary)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-surface-hover)] transition-colors cursor-pointer"
                  aria-label="Menú"
                >
                  {mobileMenuOpen ? (
          ...
          {/* Mobile nav dropdown */}
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-[var(--color-surface-border)] bg-[var(--color-bg-secondary)]">
