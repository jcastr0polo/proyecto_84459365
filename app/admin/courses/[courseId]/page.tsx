...
import { ArrowLeft, Pencil, FileText, Users, BookOpen, BarChart3, Rocket, Clock, Layers } from 'lucide-react';

type TabKey = 'resumen' | 'estudiantes' | 'actividades' | 'notas' | 'proyectos' | 'cortes';
